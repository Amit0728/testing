...
$parameters = @{
    FirstName     = "YourServerName"  # Replace with your SQL Server name
    LastName      = "YourDatabaseName"  # Replace with your Database name
    Location      = "https://github.com/your-repo/your-script.sql"  # Replace with your GitHub URL
